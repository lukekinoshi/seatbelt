  ...
  return (
    <div style={{ background: '#111', color: '#e0e0e0', fontFamily: '-apple-system, BlinkMacSystemFont, Segoe UI, sans-serif' }}>
      ...
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px 24px', textAlign: 'center', borderBottom: '0.5px solid #1e1e1e' }}>
        ...
        <p style={{ fontSize: 'clamp(12px, 2vw, 15px)', letterSpacing: '4px', color: '#555', marginBottom: '28px' }}>RIDE SMARTER. PAY LESS.</p>
        <p style={{ fontSize: 'clamp(16px, 2.5vw, 20px)', color: '#777', maxWidth: '560px', lineHeight: 1.8, marginBottom: '48px' }}>
      ...
      <div style={{ padding: '100px 24px', borderBottom: '0.5px solid #1e1e1e' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: '700', color: '#e0e0e0', textAlign: 'center', lineHeight: 1.4, marginBottom: '60px' }}>
            Simple. Human. Fair.
          </h2>
          {[
            ...
            { emoji: '📱', title: 'Riders browse the feed', desc: 'Scroll through nearby trips like a social feed. Find someone heading your way and reach out directly — no waiting, no guessing.' },
            { emoji: '💬', title: 'Negotiate a real price', desc: 'Message the driver, discuss a price that works for both of you. No algorithm decides. No surge kicks in. Just two people making a deal.' },
      ...
      <div style={{ padding: '100px 24px', borderBottom: '0.5px solid #1e1e1e', background: '#0e0e0e' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 'clamp(22px, 4vw, 34px)', fontWeight: '700', color: '#e0e0e0', lineHeight: 1.5, marginBottom: '24px' }}>
      ...
      <div style={{ padding: '100px 24px', borderBottom: '0.5px solid #1e1e1e' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(24px, 4vw, 36px)', fontWeight: '700', color: '#e0e0e0', textAlign: 'center', marginBottom: '60px', lineHeight: 1.4 }}>Everyone with somewhere to go.</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '14px' }}>
            {[
              ...
              { emoji: '🏘️', title: 'Small towns', desc: 'Where there\'s a driver, there\'s a way.' },
              { emoji: '⚡', title: 'Last minute', desc: 'Need a ride now? Someone\'s already going.' },
            ].map((item, i) => (
      ...
      <div style={{ padding: '100px 24px', textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: 'clamp(28px, 5vw, 48px)', fontWeight: '700', color: '#e0e0e0', margin: '24px 0 16px', lineHeight: 1.3 }}>
